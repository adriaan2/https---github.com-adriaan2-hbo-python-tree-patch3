...
class CarParkingMachine:
        ...
        def check_out(self, licenses,checkoutime=datetime.now() ):
                testing=True
                self.licenses=licenses
                self.checkoutime=checkoutime
                for i in self.parked_cars:
                    
                    if i==licenses:
                        self.get_parking_fee(self.licenses,self.checkoutime)
                    else: 
        ...
        def get_parking_fee(self,licenses,checkouttime=datetime.now()):
                ...
                print("parking fee:",parkingfee,"EUR")
